...
public class PieChartActivity extends AppCompatActivity implements OnSeekBarChangeListener,
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("SOFTBRILLIANCE\nejemplo");
        s.setSpan(new RelativeSizeSpan(1.7f), 0, 14, 0);
        s.setSpan(new StyleSpan(Typeface.NORMAL), 14, s.length() - 8, 0);
        s.setSpan(new ForegroundColorSpan(Color.GRAY), 14, s.length() - 8, 0);
        s.setSpan(new RelativeSizeSpan(.8f), 14, s.length() - 8, 0);
